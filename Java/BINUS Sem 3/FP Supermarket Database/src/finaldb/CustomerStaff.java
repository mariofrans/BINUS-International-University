...
public class CustomerStaff extends javax.swing.JFrame {
    ...
    private void jTextFieldSearchCustomerIDKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSearchCustomerIDKeyReleased
        ...
        try{
            ...
            if(rs.next() && flag == 0){
                ...
                jTextAreaAddress.setText("");
                jComboBoxPaymentMethod.setSelectedIndex(-1);
                //                JOptionPane.showMessageDialog(null, "Customer is not available, please create a new one", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        catch(Exception e){
            JOptionPane.showMessageDialog(null, "Error Customer Information search customer id", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerStaff().setVisible(true);
            }
        });
    }

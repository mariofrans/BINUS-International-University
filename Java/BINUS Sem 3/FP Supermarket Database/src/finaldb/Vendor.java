...
public class Vendor extends javax.swing.JFrame {
        ...
        JPanelBodyButtonsLayout.setHorizontalGroup(
            ...
            .addGroup(JPanelBodyButtonsLayout.createSequentialGroup()
                ...
                .addGroup(JPanelBodyButtonsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jButtonUpdate, javax.swing.GroupLayout.DEFAULT_SIZE, 71, Short.MAX_VALUE)
    ...
    public void set_vendorid(){
        ...
        try{
            ...
            rs = pst.executeQuery();
//            System.out.println("Vendor information set vendor id");
    ...
    private void jTextFieldSearchVendorKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldSearchVendorKeyReleased
        ...
        try{
            ...
            //            String sql = "select * from product where ProductName like '%"+jTextFieldSearchProduct.getText()+"%'";
...
//                jComboBoxVendor.setSelectedIndex(-1);
                //                JOptionPane.showMessageDialog(null, "Product is not available, please create a new one", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
        catch(Exception e){
        ...
        try{
            ...
            if(rs.next() && flag == 0){
                ...
                jTextAreaAddress.setText(rs.getString("VendorAddress"));
                jTextFieldPhoneNo.setText(rs.getString("VendorNo"));
//                jComboBoxVendor.setSelectedItem(rs.getString("VendorName"));
...
//                pst.setString(5, Vendor);
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        int choice = JOptionPane.showConfirmDialog(null, "Do you want to delete "+jTextFieldName.getText()+" Vendor Information ?","delete", JOptionPane.YES_NO_OPTION);
        ...
        if(choice == 0){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Vendor Information delete Error"+e);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        try{
            ...
            String phoneno = jTextFieldPhoneNo.getText().toString().trim();

            // update the query
            // in here, we dont update the primary key
            // alter table .... delete primary key;
            // alter table .... add primary key();
            String sql = "update vendor set VendorName = ?, VendorAddress = ?, VendorNo = ? where VendorID = ?";
            pst = con.prepareStatement(sql);
            pst.setString(1, name);
            pst.setString(2, address);
            pst.setInt(3, Integer.parseInt(phoneno));
            ...
            int i = pst.executeUpdate();
            if(i >= 1){
                JOptionPane.showMessageDialog(null, jTextFieldName.getText()+" Vendor Updated Successfully");
                update_table();
                jButtonResetActionPerformed(evt);
                set_vendorid();
            }else{
            ...
            JOptionPane.showMessageDialog(null, jTextFieldName.getText()+" Vendor information Update Error " +e);
        }

...
public class Store extends javax.swing.JFrame {
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        if(choice == 0){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Store Information delete Error"+e);
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
        ...
        try{
            ...
            String sql = "update store set StoreName = ?, Address = ? where storeID = ?";
            pst = con.prepareStatement(sql);
            ...
            JOptionPane.showMessageDialog(null, jTextFieldName.getText()+" Store information Update Error " +e);
        }

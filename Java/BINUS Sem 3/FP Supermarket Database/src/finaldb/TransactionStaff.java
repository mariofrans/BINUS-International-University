...
public class TransactionStaff extends javax.swing.JFrame {
   ...
   MySQLConnect myt;
    ...
    private void jButtonPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPrintActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null,e);
            //            System.out.println("Error while printing Transaction Information" +e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransactionStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransactionStaff().setVisible(true);
            }
        });
    }
